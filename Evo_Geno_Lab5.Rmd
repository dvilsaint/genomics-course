...
```{r, exercise2, fig.width = 5, fig.height = 10, echo = FALSE, message = FALSE, warning = FALSE, eval=FALSE}
Confirmed_State_6_13_9_13_joined <- full_join(Confirmed_State_6_13,
      Confirmed_State_9_13, by = c("Province_State"))
head(Confirmed_State_6_13_9_13_joined)
Confirmed_State_6_13_9_13_joined <- full_join(Confirmed_State_6_13,
...
```{r,echo = FALSE, message = FALSE, warning = FALSE}
### Using the time series data. Make a plot of the total number of confirmed deaths per day worldwide
```{r, exercise4, fig.width = 5, fig.height = 10, code=FALSE}
time_series_long_joined %>% 
  group_by(Date) %>% 
  summarise_at(c("Confirmed", "Deaths"), sum) %>%
    ggplot(aes(x = Date,  y = Deaths)) + 
...
### Use Mutate to make a new column with deaths/confirmed cases (Hint: this might be best done after joining the tables, but before pivoting longer)
```{r, exercise 5, fig.width = 5, fig.height = 10, echo = FALSE, message = FALSE, warning = FALSE, eval=FALSE}
time_series_long_joined %>% 
...
```{r, exercise6, fig.width = 5, fig.height = 10, echo = FALSE, message = FALSE, warning = FALSE, eval=FALSE}
### Plot US deaths/confirmed cases per day.
time_series_long_joined %>% 
  group_by(Country_Region,Date) %>% 
  summarise_at(c("Confirmed", "Deaths"), sum) %>% 
...
```{r, exercise7, fig.width = 5, fig.height = 10, echo = FALSE, message = FALSE, warning = FALSE, eval=FALSE}
...
```{r, exercise8, fig.width = 5, fig.height = 10, cecho = FALSE, message = FALSE, warning = FALSE, eval=FALSE}
time_series_long_joined %>% 
    group_by(Country_Region,Date) %>% 
    summarise_at(c("Confirmed", "Deaths"), sum) %>% 
    filter (Country_Region %in% c("Brazil","UK","Italy", 
